...
try {
    ...
    // Fetch Factories
    $factories_query = "SELECT Factory_Name, Email, Phone, District, Location FROM factory";
    $stmt = $conn->prepare($factories_query);
    $stmt->execute();
...
<head>
  ...
  <title>SyncLokal - Factory Directory</title>
  <meta name="description" content="View factory directory on SyncLokal">
  <meta name="keywords" content="factory directory, admin, SyncLokal">
    ...
    <section class="dashboard-section">
      <div class="dashboard-container">
        ...
        <div class="welcome-message" id="welcomeMessage">
          ...
          <p class="subtitle">Admin Dashboard - Factory Directory</p>
        </div>
          ...
          <table>
            ...
            <tbody>
              <?php foreach ($factories as $factory): ?>
                <tr>
                  <td><?= htmlspecialchars($factory['Factory_Name']) ?></td>
                  <td><?= htmlspecialchars($factory['Email']) ?></td>
                  <td><?= htmlspecialchars($factory['Phone']) ?></td>
                  <td><?= htmlspecialchars($factory['District']) ?></td>
                  <td><?= htmlspecialchars($factory['Location']) ?></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
