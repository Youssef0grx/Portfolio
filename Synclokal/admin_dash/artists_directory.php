...
try {
    ...
    // Fetch Creators (Artists)
    $creators_query = "
        SELECT c.Type, CONCAT(u.First_Name, ' ', u.Last_Name) AS Creator_Name, c.Pay_Rate, c.Portfolio_URL
        FROM creator c
        JOIN user u ON c.User_ID = u.User_ID";
    $stmt = $conn->prepare($creators_query);
    $stmt->execute();
...
<head>
  ...
  <title>SyncLokal - Artists Directory</title>
  <meta name="description" content="View artists directory on SyncLokal">
  <meta name="keywords" content="artists directory, admin, SyncLokal">
    ...
    <section class="dashboard-section">
      <div class="dashboard-container">
        ...
        <div class="welcome-message" id="welcomeMessage">
          ...
          <p class="subtitle">Admin Dashboard - Artists Directory</p>
        </div>
        ...
        <div class="stats-overview" data-aos="fade-up">
          <div class="stat-item">
            <div class="value"><?= $creator_count ?></div>
            <div class="label">Artists</div>
          </div>
        </div>

        <!-- Artists Directory Table -->
          ...
          <table>
            ...
            <tbody>
              <?php foreach ($creators as $creator): ?>
                <tr>
                  <td><?= htmlspecialchars($creator['Type']) ?></td>
                  <td><?= htmlspecialchars($creator['Creator_Name']) ?></td>
                  <td>$<?= htmlspecialchars($creator['Pay_Rate']) ?></td>
                  <td><a href="<?= htmlspecialchars($creator['Portfolio_URL']) ?>" target="_blank">Link</a></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
