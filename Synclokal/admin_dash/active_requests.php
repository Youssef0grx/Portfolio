...
try {
    ...
    $active_requests_query = "
        SELECT r.Request_ID, b.Brand_Name, CONCAT(u.First_Name, ' ', u.Last_Name) AS Owner_Name,
               r.Description, r.Date_Created, r.status, r.Deadline
        FROM request r
    ...
    $active_request_count = count($active_requests);
...
<head>
  ...
  <title>SyncLokal - Active Requests</title>
  <meta name="description" content="View active requests on SyncLokal">
  <meta name="keywords" content="active requests, admin, SyncLokal">
    ...
    <section class="dashboard-section">
      <div class="dashboard-container">
        ...
        <div class="welcome-message" id="welcomeMessage">
          ...
          <p class="subtitle">Admin Dashboard - Active Requests</p>
        </div>
            ...
            <tbody>
              <?php foreach ($active_requests as $req): ?>
                <tr>
                  ...
                  <td><?= htmlspecialchars($req['Date_Created']) ?></td>
                  <td><?= htmlspecialchars($req['status']) ?></td>
                  <td><?= htmlspecialchars($req['Deadline']) ?></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
