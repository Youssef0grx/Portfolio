...
if (!$user_id) {
    header("Location: /Grad/Grad2/creator_signup.php");
    exit();
}
...
try {
    ...
    if (!$creator) {
        ...
        // Fetch all bids from this creator, including brand image_data
        $stmt = $conn->prepare("
        ...
        ");
        $stmt->execute([$creator['Creator_ID']]);
...
<head>
    ...
    <title>SyncLokal - Creator Bid Status</title>
    <meta name="description" content="View your bid status on SyncLokal">
    <meta name="keywords" content="bids, creator, SyncLokal">
...
<body class="index-page">
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a href="/Grad/Grad2/creator_dash/creator-dashboard.php" class="back-btn" title="Back to Dashboard">
                        ...
                        <?php foreach ($bids as $bid): ?>
                            <div class="bid-card" data-aos="fade-up">
                                <div class="bid-header">
                                    <img src="<?php 
                                        // Use brand image if available, otherwise fallback to default
