...
try {
    ...
    // Fetch brand details
    $stmt = $conn->prepare("SELECT * FROM brand WHERE User_ID = ?");
    $stmt->execute([$user_id]);
    ...
    if (!$brand) {
        ...
        // Fetch bids related to the brand's requests
        try {
            $brand_id = $brand['Brand_ID'];
            $stmt = $conn->prepare("
                SELECT b.Bid_ID, b.Request_ID, b.Bid_Amount, b.Date_Submitted AS Date, b.Status, f.Factory_Name AS Bidder_Name
                FROM bid b
...
<head>
  ...
  <title>SyncLokal - Brand Dashboard</title>
  <meta name="description" content="Manage your brand on SyncLokal">
  <meta name="keywords" content="dashboard, brand, fashion, SyncLokal">
    ...
    <section class="dashboard-section">
      <div class="dashboard-container">
        ...
        <div class="welcome-message">
          <h2>Welcome, <span><?php echo htmlspecialchars($brand['Brand_Name'] ?? 'Brand'); ?></span>!</h2>
        </div>
        ...
        <div class="widget-grid">
          <!-- Place New Requests -->
          <a href="/Grad/Grad2/brand_dash/brand-request.php" class="widget" data-aos="fade-up" data-aos-delay="100">
            <i class="bi bi-plus-circle"></i>
            <h3>Place New Requests</h3>
            <p>Create new requests for your brand's needs.</p>
          </a>

          <!-- View Requests -->
          <a href="/Grad/Grad2/brand_dash/brand-viewbids.php" class="widget" data-aos="fade-up" data-aos-delay="200">
            <i class="bi bi-list-check"></i>
            <h3>View Bids</h3>
            <p>Track and manage Bids.</p>
          </a>

          <!-- Edit Information -->
          <a href="/Grad/Grad2/brand_dash/brand-editinfo.php" class="widget" data-aos="fade-up" data-aos-delay="300">
            <i class="bi bi-pencil-square"></i>
            <h3>Edit Information</h3>
            <p>Update your brand's profile and details.</p>
          </a>
        </div>
      </div>
